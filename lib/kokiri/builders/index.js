...
const Fixr = require('./fixr');
const Expedia = require('./expedia');
const Groupon = require('./groupon');
const Grubhub = require('./grubhub');
const Buttonia = require('./buttonia');
...
const MileagePlusX = require('./mileageplusx');
...
const WalmartGrocery = require('./walmart-grocery');
const WarbyParker = require('./warby-parker');
const Zulily = require('./zulily');
...
const subclassMap = {
  ...
  [ORGANIZATION_IDS.aliexpress]: CommissionJunction,
  ...
  [ORGANIZATION_IDS.applelite]: ImpactRadius,
  [ORGANIZATION_IDS.asos]: Asos,
  [ORGANIZATION_IDS.ashford]: CommissionJunction,
  [ORGANIZATION_IDS.ashleystewart]: CommissionJunction,
  ...
  [ORGANIZATION_IDS.barkbox]: ImpactRadius,
  [ORGANIZATION_IDS.barneys]: LinkShare,
  [ORGANIZATION_IDS.barneyswarehouse]: LinkShare,
  ...
  [ORGANIZATION_IDS.berries]: CommissionJunction,
  [ORGANIZATION_IDS.bestbuy]: LinkShare,
  [ORGANIZATION_IDS.bespokepost]: ImpactRadius,
  [ORGANIZATION_IDS.bestwestern]: CommissionJunction,
  [ORGANIZATION_IDS.biglots]: CommissionJunction,
  [ORGANIZATION_IDS.birchboxuk]: LinkShare,
  [ORGANIZATION_IDS.bloomingdales]: LinkShare,
  [ORGANIZATION_IDS.blueapron]: ImpactRadius,
  [ORGANIZATION_IDS.boohoo]: CommissionJunction,
  [ORGANIZATION_IDS.boohooman]: CommissionJunction,
  ...
  [ORGANIZATION_IDS.carhartt]: CommissionJunction,
  [ORGANIZATION_IDS.catherines]: LinkShare,
  [ORGANIZATION_IDS.casper]: Casper,
  [ORGANIZATION_IDS.caviar]: Caviar,
  [ORGANIZATION_IDS.centurytwentyone]: ImpactRadius,
  [ORGANIZATION_IDS.champion]: LinkShare,
  ...
  [ORGANIZATION_IDS.famousfootwear]: LinkShare,
  [ORGANIZATION_IDS.fandango]: CommissionJunction,
  [ORGANIZATION_IDS.finishline]: LinkShare,
  [ORGANIZATION_IDS.firstchoice]: CommissionJunction,
  [ORGANIZATION_IDS.fixr]: Fixr,
  [ORGANIZATION_IDS.footlocker]: LinkShare,
  [ORGANIZATION_IDS.forevertwentyone]: CommissionJunction,
  [ORGANIZATION_IDS.fossil]: CommissionJunction,
  [ORGANIZATION_IDS.ftd]: CommissionJunction,
  [ORGANIZATION_IDS.game]: LinkShare,
  [ORGANIZATION_IDS.gamestop]: LinkShare,
  [ORGANIZATION_IDS.gap]: CommissionJunction,
  [ORGANIZATION_IDS.gapfactory]: CommissionJunction,
  [ORGANIZATION_IDS.glossybox]: Awin,
  [ORGANIZATION_IDS.gnc]: CommissionJunction,
  [ORGANIZATION_IDS.goodyear]: CommissionJunction,
  [ORGANIZATION_IDS.greenchef]: CommissionJunction,
  [ORGANIZATION_IDS.groupon]: Groupon,
  [ORGANIZATION_IDS.grubhub]: Grubhub,
  [ORGANIZATION_IDS.gymshark]: Awin,
  [ORGANIZATION_IDS.buttonia]: Buttonia,
  [ORGANIZATION_IDS.hanes]: LinkShare,
  [ORGANIZATION_IDS.happysocks]: LinkShare,
  ...
  [ORGANIZATION_IDS.hurley]: CommissionJunction,
  ...
  [ORGANIZATION_IDS.jimmyjazz]: CommissionJunction,
  [ORGANIZATION_IDS.joann]: LinkShare,
  [ORGANIZATION_IDS.journeys]: CommissionJunction,
  [ORGANIZATION_IDS.kiwico]: ImpactRadius,
  [ORGANIZATION_IDS.kobo]: LinkShare,
  ...
  [ORGANIZATION_IDS.loewshotels]: Awin,
  [ORGANIZATION_IDS.loft]: LinkShare,
  [ORGANIZATION_IDS.loftoutlet]: LinkShare,
  [ORGANIZATION_IDS.lookfantastic]: Awin,
  [ORGANIZATION_IDS.lordandtaylor]: LinkShare,
  [ORGANIZATION_IDS.lorextechnology]: ImpactRadius,
  ...
  [ORGANIZATION_IDS.matchuk]: CommissionJunction,
  [ORGANIZATION_IDS.menswearhouse]: LinkShare,
  [ORGANIZATION_IDS.michaelkors]: CommissionJunction,
  [ORGANIZATION_IDS.mileageplusx]: MileagePlusX,
  ...
  [ORGANIZATION_IDS.partycity]: CommissionJunction,
  ...
  [ORGANIZATION_IDS.photobox]: CommissionJunction,
  [ORGANIZATION_IDS.pieroneimports]: CommissionJunction,
  [ORGANIZATION_IDS.postmates]: Postmates,
  ...
  [ORGANIZATION_IDS.sixpm]: CommissionJunction,
  [ORGANIZATION_IDS.sixzerotwo]: LinkShare,
  [ORGANIZATION_IDS.skinstore]: Awin,
  [ORGANIZATION_IDS.societysix]: CommissionJunction,
  ...
  [ORGANIZATION_IDS.staplesuk]: CommissionJunction,
  [ORGANIZATION_IDS.steinmart]: CommissionJunction,
  [ORGANIZATION_IDS.stevemadden]: LinkShare,
  [ORGANIZATION_IDS.superchewer]: ImpactRadius,
  [ORGANIZATION_IDS.superdry]: Awin,
  [ORGANIZATION_IDS.stitchfix]: ImpactRadius,
  [ORGANIZATION_IDS.strollerhaus]: LinkShare,
  [ORGANIZATION_IDS.target]: ImpactRadius,
  [ORGANIZATION_IDS.techarmor]: LinkShare,
  [ORGANIZATION_IDS.tedbaker]: Awin,
  ...
  [ORGANIZATION_IDS.tommy]: LinkShare,
  [ORGANIZATION_IDS.toms]: LinkShare,
  [ORGANIZATION_IDS.tophatter]: Tophatter,
  [ORGANIZATION_IDS.touchofmodern]: CommissionJunction,
  [ORGANIZATION_IDS.travelocity]: Travelocity,
  [ORGANIZATION_IDS.tripadvisor]: CommissionJunction,
  ...
  [ORGANIZATION_IDS.urbanstems]: LinkShare,
  [ORGANIZATION_IDS.verizon]: CommissionJunction,
  [ORGANIZATION_IDS.viator]: Awin,
  [ORGANIZATION_IDS.vitacost]: LinkShare,
  [ORGANIZATION_IDS.vitaminshoppe]: CommissionJunction,
  ...
  [ORGANIZATION_IDS.walmartgrocery]: WalmartGrocery,
  ...
  [ORGANIZATION_IDS.zulily]: Zulily,
};
